...
*/
export function start(id, password) {
    ...
    var ret = wasm.start(ptr0, len0, ptr1, len1);
    return GroupWrapper.__wrap(ret);
}
...
* @returns {Uint8Array}
*/
export function msg(wrapper) {
    _assertClass(wrapper, GroupWrapper);
    wasm.msg(8, wrapper.ptr);
...
* @returns {Uint8Array}
*/
export function finish(wrapper, inbound) {
    _assertClass(wrapper, GroupWrapper);
    var ptr0 = wrapper.ptr;
    wrapper.ptr = 0;
    var ptr1 = passArray8ToWasm0(inbound, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    wasm.finish(8, ptr0, ptr1, len1);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
...
export class GroupWrapper {
    ...
    static __wrap(ptr) {
        const obj = Object.create(GroupWrapper.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_groupwrapper_free(ptr);
    }
}
